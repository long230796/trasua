                                          ...
                                          <td class="content-wrap">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      <td class="content-block" itemprop="handler" itemscope="" itemtype="http://schema.org/HttpActionHandler">
                                                         <a ng-click="xacnhan2(dh.MADONHANG, 2, dh.MAHOADON)" class="btn-primary" itemprop="url">Xác nhận</a>
                                                      </td>
                                                   </tr>
                                                </tbody>
                                             </table>
                                             ...
                                             <table ng-show="{{dh.TRANGTHAIDONHANG === '3' ? 'true' : ''}}" width="100%" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      <td class="content-block" itemprop="handler" itemscope="" itemtype="http://schema.org/HttpActionHandler">
                                                         <a ng-click="giaohang2(dh.MADONHANG, 4, dh.MAHOADON)" href="#" class="btn-primary" itemprop="url">Giao hàng</a>
                                                      </td>
                                                   </tr>
                                                </tbody>
                                             </table>
