        ...
        <div class="content-view" ng-controller="managedAccount">
            <div class="layout-xs contacts-container">
              <div class="flexbox-xs layout-column-xs contacts-list b-r">
                ...
                <div class="flex-xs scroll-y" ng-init='khachhang=<?php echo json_encode($mangdulieu['khachhang'])?>'>
                  <!--Contact list item-->
                  <a href="javascript:;" class="column-equal" data-toggle="contact" ng-repeat="kh in khachhang | filter: searchNV" ng-click="setNhanvien(kh)" >
                    ...
                    <div class="col v-align-middle contact-details p-l-1">
                      <span class="bold">{{kh.HO}} {{kh.TEN}}</span>
                      <span class="small">{{kh.MAKH}}</span>
                    </div>
                  </a>
              ...
              <div class="flexbox-xs layout-column-xs contact-view">
                ...
                <div class="flex-xs scroll-y p-a-3" ng-init='single=<?php echo json_encode($mangdulieu['khachhang'][0])?>'>
